...
#       Normally present when the package is an odd version (such a file: or link: package) while
#       also have peer dependencies in the key.
#
...
#   friendly_version:
#
#   dev: True if the package is exclusively a dev dependency throughout the workspace
